...
class Monkeys {
    ...
    //We have a set of monkeys.  Each Monkey has a boolean smile property, which indicates if that particular
        // monkey is smiling.  Determine whether or not the majority of monkeys are smiling.  If the majority are
        // smiling, return true.  if the majority are not smiling, return false.  If it is a tie, return true.
        return true;
    }
